...
UUID=${UUID:-'e423a4f7-ce7c-42b2-95aa-f7ec60fa1fa7'}
VMESS_WSPATH=${VMESS_WSPATH:-'/e423a4f7-ce7c-42b2-95aa-f7ec60fa1fa7-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/e423a4f7-ce7c-42b2-95aa-f7ec60fa1fa7-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'e423a4f7-ce7c-42b2-95aa-f7ec60fa1fa7-/trojan'}
SS_WSPATH=${SS_WSPATH:-'/e423a4f7-ce7c-42b2-95aa-f7ec60fa1fa7-shadowsocks'}
